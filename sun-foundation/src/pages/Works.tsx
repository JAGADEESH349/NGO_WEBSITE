...
const projects = [
  { id: '1', title: 'Free Medical Camp — Guntur', category: 'Healthcare', description: 'Served 800+ patients with free consultations, medicines, and diagnostic tests.', impact: '800+ Patients', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&q=80', badge: 'navy' as const },
  { id: '2', title: 'Digital Classroom Initiative', category: 'Education', description: 'Set up 10 smart classrooms in government schools across Krishna district.', impact: '2000+ Students', image: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?w=400&q=80', badge: 'slate' as const },
  ...
  { id: '5', title: 'Sunday Food Drive', category: 'Food', description: 'Weekly meal distribution to 200+ families every Sunday across Vijayawada.', impact: '52 Sundays/Year', image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=400&q=80', badge: 'navy' as const },
  { id: '6', title: 'Maternal Health Program', category: 'Healthcare', description: 'Prenatal care, nutrition support, and awareness for 300+ rural mothers.', impact: '300+ Mothers', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&q=80', badge: 'navy' as const },
  { id: '7', title: 'Scholarship Program 2024', category: 'Education', description: 'Merit-cum-need scholarships for 150 deserving students for higher education.', impact: '150 Scholars', image: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=400&q=80', badge: 'slate' as const },
    ...
    <>
                ...
                <Card className="h-full overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-navy-500 font-bold text-sm font-body">📊 {project.impact}</span>
                      <Button variant="ghost" size="sm" className="text-navy-500 hover:text-navy-600 p-0 h-auto gap-1">
      ...
      <section id="teams" ref={ref as React.RefObject<HTMLElement>} className="section-padding bg-muted/20">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          >
            <p className="text-navy-500 font-semibold font-body text-sm uppercase tracking-widest mb-2">The People Behind the Work</p>
                      ...
                      <div className="md:w-3/5 p-6 md:p-8 flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          <span className="flex items-center gap-1.5 text-sm text-muted-foreground">
                            <Users className="w-4 h-4 text-navy-500" /> {team.memberCount} members
                          </span>
                          <span className="text-navy-500 font-semibold text-sm">• {team.impact}</span>
                        </div>
                        <p className="text-muted-foreground font-body leading-relaxed mb-5">{team.description}</p>
                        <Button asChild variant="navy-outline" size="sm" className="self-start">
